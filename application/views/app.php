...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/spatialcss/dependenciesUpdated2017_review.css'.'?v='.$version) ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/spatialcss/main-mimiUpdated2017_review.css'.'?v='.$version) ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/css/loaders.min.css'.'?v='.$version) ?>">
	<link rel="stylesheet" href="<?php echo base_url('/assets/spatialcss/styledLayerControlUpdated2017.css'.'?v='.$version) ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/spatialcss/bootstrap-datepicker.min.css'.'?v='.$version) ?>" />
	<script src="<?php echo base_url('/assets/spatialjs/bundleUpdate2017_review.js'.'?v='.$version) ?>"></script>
	<link rel="stylesheet" href="../assets/css/webapp.css">
 <?php
		// if($council->storm1){
		// 	echo '<script ...../storm/core.js?v=>'. +
		// }
	?>
	...
	<script>
		...
		function Agree() {
			document.cookie = "accepted-license-terms=" + JSON.stringify({
				name: currentUser,
...
<body>
							...
							<div class="collapse navbar-collapse" id="retic-navbar-collapse">
								<ul class="navigation nav navbar-nav navbar-right">
									<li class="navigation-padding navigation-text">
										<h5 title="Start again" id="home-button"><span onclick="resetPage()" class="navigation-text-a">home</span></h5>
									</li>
									<li class="navigation-text-a navigation-padding navigation-text">
										<a href="mailto:info@reticmanager.com"></a>
										<h5 class="navigation-text-a" title="For support via email" id="support-button"><a href="mailto:info@reticmanager.com"></a><a href="mailto:info@reticmanager.com" class="navigation-text-a">support</a></h5>
									</li>
									<?php if ($admin) { ?>
									<li class="navigation-padding navigation-text">
										<a href="<?php echo base_url("view/$council->code/surveys"); ?>"><h5 class="navigation-text-a" title="Field data capture" id="webnav">add survey</h5></a>
									</li>
									<?php } ?>

									<li class="navigation-padding navigation-text">
										<h5><span id="upload-button" title="Upload data to ReticManager" onclick="logout()" class="navigation-text-a">upload</span></h5>
									</li>
									<li class="navigation-padding navigation-text dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">
											<h5 id="view-button">view<b class="caret"></b></h5>
										</a>
										<ul class="dropdown-menu" style="display: none; width: 140px; right: 0px;">
											<div class="navigation-text-simple menu-item-radio" id="lblac-split-5050">
												...
												<label for="split-5050"><span style="display: inline-block;"> Split 50/50</span></label>
											</div>
											<div class="navigation-text-simple menu-item-radio" id="lblac-split-7525">
												...
												<label for="split-7525"><span style="display: inline-block;"> Split 75/25</span></label>
											</div>
											<div class="navigation-text-simple menu-item-radio" id="lblac-map-only">
												...
												<label for="map-only"><span style="display: inline-block;"> Map</span></label>
											</div>
											<div class="navigation-text-simple menu-item-radio" id="lblac-table-only">
												...
												<label for="table-only"><span style="display: inline-block;"> Table</span></label>
											</div>
										</ul>
									</li>
									<li class="navigation-padding navigation-text dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">
											<h5 title="Show Legend" id="legend-button">legend<b class="caret"></b></h5>
										</a>
										<ul class="dropdown-menu" style="display: none; width: 275px; right: 0px;">
											...
											<li>
												<div> <img src="<?php if ($council->code !='mar170') {echo base_url('/assets/images/legend_v3.1.png');} else {echo base_url('/assets/images/legend_v3.png');} ?>" alt="online solution legend" style="width: auto; height: auto; padding: 2px">
												</div>
											</li>

										</ul>
									</li>
									<li class="navigation-text-a navigation-padding navigation-text dropdown">
										<a href="<?php echo base_url('/account/logout') ?>"></a>
										<h5 class="navigation-text-a" title="Logout of ReticManager" id="logout-button1"><a href="<?php echo base_url('/account/logout') ?>"></a><a href="<?php echo base_url('/account/logout') ?>" class="navigation-text-a">logout</a></h5>
									</li>
									<li id="menu-dropdown" class="navigation-padding navigation-text dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">
											<h5 title="ReticManager Menu - Select a network to start" id="menu-button">menu<b class="caret"></b></h5>
										</a>
										<ul class="Retic-menu dropdown-menu " style="display: none;">
											...
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="no-padding divider"></li>
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="no-padding">
												<button id="evaluation-reports-button" class="Retic-menu-buttons btn btn-default">Evaluation Reports</button>
											</li>
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="no-padding navigation-text-simple divider"></li>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation1">
												<input type="checkbox" name="gis_evaluation" class="regular-checkbox giseval" id="gis" style="margin-left: 15px;">
												<label for="gis"><span style="display: inline-block;"> GIS Amendments</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation2">
												<input type="checkbox" name="ip_evaluation" class="regular-checkbox ipeval" id="ip" style="margin-left: 15px;">
												<label for="ip"><span style="display: inline-block;"> Infiltration Observations</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation3">
												<input type="checkbox" name="prolat_evaluation" class="regular-checkbox prolateval" id="prolat" style="margin-left: 15px;">
												<label for="prolat"><span style="display: inline-block;"> Protruding Laterals</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation4">
												<input type="checkbox" name="root_evaluation" class="regular-checkbox rooteval" id="root" style="margin-left: 15px;">
												<label for="root"><span style="display: inline-block;"> Root Removal</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation5">
												<input type="checkbox" name="mhaccess_evaluation" class="regular-checkbox mhaccesseval" id="mhaccess" style="margin-left: 15px;">
												<label for="mhaccess"><span style="display: inline-block;"> Manhole Improvements</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation6">
												<input type="checkbox" name="remedial_evaluation" class="regular-checkbox remedialeval" id="remedial" style="margin-left: 15px;">
												<label for="remedial"><span style="display: inline-block;"> Remedial Works</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation7">
												<input type="checkbox" name="cctv_evaluation" class="regular-checkbox cctveval" id="cctv" style="margin-left: 15px;">
												<label for="cctv"><span style="display: inline-block;"> CCTV Re-survey</span></label>
											</div>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Evaluation8">
												<input type="checkbox" name="renewal_evaluation" class="regular-checkbox renewaleval" id="renewal" style="margin-left: 15px;">
												<label for="renewal"><span style="display: inline-block;"> Renewal Works</span></label>
											</div>
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?>class="no-padding divider"></li>
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
											...
											<li <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="no-padding divider"></li>
											<div <?php if ($council->code =='mar170') { ?>style="display:none;"
												<?php } ?> class="navigation-text-simple menu-item-radio" id="lblac-Subdivision">
												<input type="checkbox" name="subdivisions" class="regular-checkbox subdivisions" id="subdivisions" style="margin-left: 15px;">
												<label for="subdivisions"><span style="display: inline-block;"> Subdivisions</span></label>
											</div>
										</ul>
									</li>
								</ul>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-2">
									...
									<input type="text" class="form-control" rows="1" required="required" placeholder="project name / area" id="form_project_name"
									name="project_name" style="margin-left: 5px;">
								</div>
								<div class="col-sm-2">
									<label class="control-label" style="margin-left: 15px;">Project Reference</label>
									<input type="text" class="form-control" rows="1" placeholder="project reference" id="form_project_reference" name="project_reference"
									style="margin-left: 15px;">
								</div>
								<div class="col-sm-2">
									<label class="control-label" style="margin-left: 25px;">Expected Project Mtrs</label>
									<input type="text" class="form-control" rows="1" required="required" placeholder="0 mtrs" id="form_project_meterage" name="project_meterage"
							...
							<div class="row">
								<div class="col-sm-2">
									...
									<input type="text" class="form-control" rows="1" placeholder="contact name" id="form_council_contact" name="council_contact"
									style="margin-left: 5px;">
								</div>
								<div class="col-sm-2">
									<label for="inspection_purpose" style="margin-left: 15px;">Inspection Purpose</label>
									<select class="form-control" id="inspection_purpose" name="inspection_purpose" style="margin-left: 15px;"><option>Planned Project</option><option>Subdivision</option><option>Operations & Maintenance</option></select>
								</div>
							</div>
						</div>
						<br>
	...
	<div class="modal fade" style="z-index:100000;" id="evalReportsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table align="center" id="evaluation-report-table" class="display table-hover table-bordered table-striped table-responsive dataTable"
	...
	<div class="modal fade" style="z-index:100000;" id="subdivisionReportsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table align="center" id="subdivision-report-table" class="display table-hover table-bordered table-striped table-responsive dataTable"
					cellspacing="0" width="95%">
						<thead>
							<tr>
								<th>report_number</th>
	...
	<div class="modal fade" style="z-index:100000;" id="dataFilesModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table align="center" id="data-files-table" class="display table-hover table-bordered table-striped table-responsive dataTable"
					cellspacing="0" width="95%">
						<thead>
							<tr>
				...
				<div class="modal-body">
					...
					<div class="module workflow-form active">
						...
						<form style="max-width: 100%;">
										...
										<div class="form-container bound-visible" style="margin-top: 5px;">
											<div class="form-container bound-visible">
												...
												<p class="form-item form-desc bound-visible">Terms and Conditions
													<br>By proceeding and using the ReticManager Online Solution, you are agreeing to ReticManager terms and conditions
													as stated here <a href="https://reticmanager.com/termsandconditions/" target="_blank" title="ReticManager terms and conditions">reticmanager.com/termsandconditions</a>
													<br>
													<br>GIS and Spatial Locations
													<br>ReticManager accepts no responsibility for any location and information inaccuracy shown through online
													solution, Information shown on plans is indicative only. Users of this system are responsible to ensure that
													the data accessed and used is appropriate and applicable to the end use intended.
													<br>GIS data is sourced from the client and updated periodically. GIS updates are welcome and if you would like
													to provide us with an update, send an email to <a href="mailto:info@reticmanager.com?subject=GIS Update">info@reticmanager.com</a>
												</p>
							...
							<br>
							<button type="button" id="startup-close-button-1" class="modal-button wastebuttoncolor wastebackground btn btn-default "
							onclick="Agree()" data-dismiss="modal">Agree and Proceed</button>
							<br>
							<br>
							<div class="form-item required">
								<div class="form-container bound-visible" style="margin-top: 5px;">
									<div class="form-container bound-visible">
										...
										<p class="form-item form-desc bound-visible">To Start using ReticManager Online Solution you must select a network via the menu
											<br>This is shown below, it should be located at the top right of your screen when this window is closed. Please
											see reference images below.
											<br>

										</p>
										<div class="image bound-visible">
											<div class="inner"><img src="<?php echo base_url('/assets/images/basic_instructions.gif') ?>" alt="basic instructions gif image"
		...
		<div class="infowindow-custom" id="cctv_lines_infowindow_div" style="width:350px">
			...
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					...
					<table align="center" id="cctv_infowindow_table" class="display compact table-hover  dataTable" style="padding:0" cellspacing="0"
					width="100%">
						<thead>
							<tr>
								<td>
					...
					<table align="center" id="cctv_infowindow_table_condition" class="display compact" style="padding:0px;text-align: center;margin-left: -7px;"
					...
					<table align="center" id="cctv_infowindow_evaluation" class="display compact" style="padding:0px;text-align: left;margin-left: -7px;"
					cellspacing="0" width="100%">
						<thead>
							<tr>
								{{#evaluation_comments}}
		...
		<div class="infowindow-custom" id="node_inspections_infowindow_div" style="width:350px; height:500px;">
			...
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					...
					<table align="center" id="node_inspection_infowindow_table" class="display compact table-hover  dataTable" style="padding:0"
					cellspacing="0" width="100%">
						<thead>
							<tr>
								<td>
					...
					<table align="center" id="node_inspection_infowindow_table_condition" class="display compact" style="padding:0px;text-align: center;margin-left: -7px;"
					cellspacing="0" width="100%">
						<thead>
							<tr>
								<td style="border-bottom: 1px solid;"></td>
					...
					<table align="center" id="node_inspection_infowindow_observations" class="display compact table-hover  dataTable" style="padding:0"
					cellspacing="0" width="100%">
						<tr>
							<td style="border-bottom: 1px solid;"></td>
							<td style="border-bottom: 1px solid;">
		...
		<div class="infowindow-custom" id="cctv_node_start_infowindow_div" style="width:350px">
			...
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					...
					<table align="left" id="startnode_infowindow_table" class="display compact table-hover  dataTable" style="padding:0" cellspacing="0"
					width="100%">
						<thead>
							<tr>
								<td>
					...
					<table align="center" id="startnode_infowindow_condition" class="display compact" style="padding:0px;text-align: center;margin-left: -7px;"
					cellspacing="0" width="100%">
						<thead>
							<tr>
								<td style="border-bottom: 1px solid;"></td>
		...
		<div class="infowindow-custom" id="cctv_node_finish_infowindow_div" style="width:350px">
			...
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					...
					<table align="left" id="finishnode_infowindow_table" class="display compact table-hover  dataTable" style="padding:0" cellspacing="0"
					width="100%">
						<thead>
							<tr>
								<td>
					...
					<table align="center" id="finishnode_infowindow_table_condition" class="display compact" style="padding:0px;text-align: center;margin-left: -7px;"
					cellspacing="0" width="100%">
						<thead>
							<tr>
								<td style="border-bottom: 1px solid;"></td>
	...
	<script type="infowindow/html" id="gis_lines_infowindow_template">
		<div class="infowindow-custom" id="gis_lines_infowindow_div" style="width:350px">
			<div class="cartodb-popup-header" style="text-align: center;">
				<h4 class="obs-title" style="width: 100%;align-content: center;padding: 1px;padding-right: 0px;margin-top: 0px;margin-left: -10px;background-color: rgba(200,200,200,.8);text-align:center;font-weight: bold;">
					GIS ASSET DATA</h4>
				<br>
			</div>
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					<table align="center" id="gis_lines_infowindow_table" class="display compact table-hover  dataTable" style="padding:0" cellspacing="0"
					width="100%">
						<thead>
							<tr>
								<td>
	...
	<script type="infowindow/html" id="gis_nodes_infowindow_template">
		<div class="infowindow-custom" id="gis_nodes_infowindow_div" style="width:350px">
			...
			<div class="cartodb-popup-content" style=" cursor: pointer;">
				<div class="content" style="padding:0px">
					<table align="center" id="gis_nodes_infowindow_table" class="display compact table-hover  dataTable" style="padding:0" cellspacing="0"
					width="100%">
						<thead>
							<tr>
								<td>
	...
	<script src="<?php echo base_url('/assets/spatialjs/app-mimi.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/select2_review.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/jquery.dataTables.yadcf_review.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/styledLayerControl.js'.'?v='.$version) ?>"></script>
	<?php if ($council->evaluation_reports == '1') { ?> <script src="<?php  echo base_url('/assets/spatialjs/evalmain.js'.'?v='.$version) ?>"></script><?php } ?>
	<script src="<?php echo base_url('/dist/bundle.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/core.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/table.js?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/map.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/format.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/load.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/action.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/buttonactions.js'.'?v='.$version) ?>"></script>
	<script src="<?php echo base_url('/assets/spatialjs/uploadform.js'.'?v='.$version) ?>"></script>
